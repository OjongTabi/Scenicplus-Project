...
for metacluster in "${metaclusters[@]}"; do
    ...
    # Output directory
    path_to_output="/n/sci/SCI-004375-NYUDATA/Ojong/scenicplus_project/results/${metacluster}/P24_P48_Adult"
...
#SBATCH --job-name="run_scenicplus_${metacluster}"
#SBATCH --output="run_scenicplus_${metacluster}_%j.out"
#SBATCH --error="run_scenicplus_${metacluster}_%j.err"
...
# Run pycisTopic
python3 /n/sci/SCI-004375-NYUDATA/Ojong/scenicplus_project/code/run_scenicplus/run_pycistopic.py \
    --path_to_fragments "/n/sci/SCI-004375-NYUDATA/Ojong/scenicplus_project/data/Fragments/atac_fragments_${metacluster}.tsv.gz" \
    --path_to_regions "/n/sci/SCI-004375-NYUDATA/Ojong/scenicplus_project/data/dars/P24_P48_Adult/${metacluster}/P24_P48_Adult_peaks.bed" \
    --path_to_cell "/n/sci/SCI-004375-NYUDATA/Ojong/scenicplus_project/data/cell_metadata/${metacluster}_cell_data.tsv" \
    --path_to_output "$path_to_output"

# Copy Signac DARs
cp -r "/n/sci/SCI-004375-NYUDATA/Ojong/scenicplus_project/data/dars/P24_P48_Adult/${metacluster}/DARs_cell_type" "$path_to_output/region_sets/"

# Run pycisTarget
/n/sci/SCI-004375-NYUDATA/Ojong/scenicplus_project/code/run_scenicplus/creating_custom_cistarget_database.sh \
    "/n/sci/SCI-004375-NYUDATA/Ojong/scenicplus_project/data/dars/P24_P48_Adult/${metacluster}/P24_P48_Adult_peaks.bed" \
    "${metacluster}" \
    "$path_to_output"
