...
write.table(M@meta.data, file = paste0("/n/sci/SCI-004375-NYUDATA/Ojong/scenicplus_project/data/cell_metadata/", "P0-Tm-M28", "_cell_data.tsv"), sep = "\t", quote = FALSE, row.names = TRUE, col.names = TRUE)
