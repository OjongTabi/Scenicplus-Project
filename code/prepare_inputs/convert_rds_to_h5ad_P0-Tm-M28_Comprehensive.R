...
P15_Tm = readRDS("/n/sci/SCI-004375-NYUDATA/Data/Ozel21/P15_Tm.rds")
P15_Tm$AnnotatedJul24 <- as.character(Idents(P15_Tm))
P15_Tm$Idents <- as.character(Idents(P15_Tm))

# Merge Multiome data with the external RNA-seq data
combined_data <- merge(M, y = list(P15_Tm), 
...
output_path <- paste0(output_dir, "P0-Tm-M28", "_RNA.h5Seurat")
